...
var all_questions = [{
  question_string: "What requirement is violated (Hollow Brick: ASTM C 652, Grade SW, Class H40V (void areas between 25 and 40 percent of gross cross-sectional area, Type HBX.)?",
  choices: {
    correct: "R1",
    wrong: ["R1", "R2", "R3"]
  }
}, {
  question_string: "What Rule is violated (Hollow Brick: ASTM C 652, Grade SW, Class H40V (void areas between 25 and 40 percent of gross cross-sectional area, Type HBX.)?",
  choices: {
    correct: "R33",
    wrong: ["R12", "R22", "R33"]
  }
  ...
  choices: {
    correct: "Use terms table",
    wrong: ["Assume", "Search google", "Use terms table"]
  }
}];
